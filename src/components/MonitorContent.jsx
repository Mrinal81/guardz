...
const MonitorFilter = ({monitorFilterClose}) => {
  return(
    <div className="monitor-filter-dropdown-content" onClick={monitorFilterClose}>
      <div className="monitor-filter-drop-content">
        <input type="text" placeholder="Filter" />
      </div>
      <div className="monitor-drop-contents-filter">
        <p>Status</p>
        <span>5 Items</span>
      </div>
      <div className="monitor-drop-contents-filter">
...
const MonitorContent = () => {
  const [isMonitorFilterVisible, setMonitorFilterVisible]= useState(false);


  
  const openMonitorFilter = () => {
    setMonitorFilterVisible(true);
  }
  const closeMonitorFilter = () => {
    setMonitorFilterVisible(false);
  }
      ...
      <div className='monitorHeader'>
        <div className="monitorButtons">
          ...
          <div className="globeworkbtns">
            ...
            <button className='filter'  onClick={isMonitorFilterVisible ? closeMonitorFilter : openMonitorFilter} >
            {isMonitorFilterVisible && <MonitorFilter filterClose={closeMonitorFilter} />}
