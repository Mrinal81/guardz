...
const GlobeFilter = ({globeFilterClose}) => {
  return(
    <div className="globe-filter-dropdown-content" onClick={globeFilterClose}>
      <div className="globe-filter-drop-content">
        <input type="text" placeholder="Filter" />
      </div>
      <div className="globe-drop-contents-filter">
        <p>Type</p>
        <span>3 Items</span>
      </div>
...
const GlobeContent = () => {
  ...
  const [isGlobeFilterVisible, setGlobeFilterVisible]= useState(false);
  ...
  const openGlobeFilter = () => {
    setGlobeFilterVisible(true);
  }
  const closeGlobeFilter = () => {
    setGlobeFilterVisible(false);
  }
      ...
      <div className='globeHeader'>
        <div className="globeButtons">
          ...
          <div className="globeworkbtns">
            ...
            <button className='filter' onClick={isGlobeFilterVisible ? closeGlobeFilter : openGlobeFilter}>
            {isGlobeFilterVisible && <GlobeFilter globeFilterClose={closeGlobeFilter} />}
