...
const UserFilter = ({userFilterClose}) => {
  return(
    <div className="user-filter-dropdown-content" onClick={userFilterClose}>
      <div className="user-filter-drop-content">
        <input type="text" placeholder="Filter" />
      </div>
      <div className="user-drop-contents-filter">
        <p>Status</p>
        <span>3 Items</span>
      </div>
      <div className="user-drop-contents-filter">
      ...
      <div className='userHeader'>
        <div className="userButtons">
          ...
          <div className="userworkbtns">
            ...
            <button className='filter' onClick={isUserFilterVisible ? closeUserFilter : openUserFilter} >
              {isUserFilterVisible && <UserFilter userFilterClose= {closeUserFilter} />}
