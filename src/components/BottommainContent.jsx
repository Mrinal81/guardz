          ...
          <div className="insights">
            <div className="insights-content">
              <div className="insights-main-contents">
                ...
                <button className='securitybtn'><img src={error} alt="error" />Security</button>
                <button className='tipsbtn'><img src={task} alt="task" />Tips</button>
                ...
                <input type="checkbox" checked={isIgnored} onChange={handleToggle} />
